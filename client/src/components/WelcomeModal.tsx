...
const STEPS = [
  {
    ...
    description: "유언 작성부터 사후 자동 집행까지, 전 과정을 책임집니다. 지금부터 5분이면 기본 설정을 완료할 수 있습니다.",
    tip: null,
  },
  {
  ...
  },
  {
    ...
    title: "전자 인증 (₩49,000)",
    subtitle: "법적 효력 있는 유언장으로",
    description: "eKYC 본인확인 + 얼굴 인식 + 음성 의사 확인으로 법적 효력을 부여합니다. 블록체인에 해시를 기록해 위변조가 불가능합니다.",
    tip: "💡 첫 1년 보관이 무료로 포함됩니다.",
  },
  {
    ...
    description: "가족 신고 → 정부 DB 연동 → Dead Man's Switch → Badge 발견 신고. 4가지 방법으로 교차 검증 후 유언을 자동 집행합니다.",
