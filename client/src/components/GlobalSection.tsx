...
const extraCountries = [
  {
    ...
    phase: "5th", period: "Year 2", statusColor: "bg-gray-400",
    highlights: ["Wills Act 2007 (NZ) — Immediately Applicable", "Electronic Transactions Act 2002", "Stripe · Visa · Mastercard", "Overseas Korean & Expat Community"],
    payment: "Stripe · Visa", legalNote: "Wills Act 2007 (NZ) · Electronic Transactions Act 2002",
  ...
  },
  {
    ...
    phase: "5th", period: "Year 2", statusColor: "bg-gray-400",
    highlights: ["Succession Act 2006 (NSW) — NSW Applicable", "Electronic Transactions Act 1999", "Stripe · BPAY · PayID", "Korean-Australian Community"],
    payment: "Stripe · BPAY · PayID", legalNote: "Succession Act 2006 (NSW) · State Laws Apply · Electronic Transactions Act 1999",
    icons: [ShieldCheck, Zap, CreditCard, Users],
  },
  {
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <AnimatePresence mode="wait">
          {selectedPin && selectedData && (
            ...
            >
              <div               className="bg-white/10 backdrop-blur-sm border border-[#C9A961]/30 rounded-3xl p-5 sm:p-8 hover:bg-white/12 transition-all shadow-xl shadow-black/20">
                {/* 상단: 단계 배지 + 상태 */}
                ...
                {/* 국가 전용 페이지 링크 버튼 - US만 홈(/), 나머지(JP/AU/NZ/CA 등)는 해당 국가 페이지 */}
                <a
                  href={selectedData.countryCode.toLowerCase() === "us" ? "/" : `/country/${selectedData.countryCode.toLowerCase() === "sa" ? "sa" : selectedData.countryCode.toLowerCase() === "in" ? "in" : selectedData.countryCode.toLowerCase()}`}
        ...
        >
          ...
          {/* 11개 언어 카드 그리드 - 모바일 2줄 wrap 레이아웃 */}
