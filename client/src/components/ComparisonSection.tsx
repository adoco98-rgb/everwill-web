  ...
  const localeData = {
    ...
    fr: {
      ...
      rows: [
        ...
        {
          icon: FileText,
          label: "Validité juridique",
          traditional: "Testament notarié",
          traditionalSub: "Art. 971 Code civil — testament authentique",
          everwill: "Testament électronique certifié",
          everwillSub: "eKYC + horodatage blockchain + RFC 3161",
          highlight: false,
        },
        {
          icon: AlertTriangle,
          ...
          traditional: "Élevé",
          traditionalSub: "Original perdu = invalide. Beaucoup de testaments jamais retrouvés",
          everwill: "Aucun",
          everwillSub: "Cloud chiffré + stockage permanent blockchain",
          highlight: false,
        },
        {
          icon: Zap,
    ...
    ru: {
      ...
      rows: [
        ...
        {
          icon: FileText,
          label: "Юридическая сила",
          traditional: "Нотариально заверенное завещание",
          traditionalSub: "Ст. 1125 ГК РФ — нотариально удостоверенное завещание",
        ...
        },
        {
          ...
          label: "Риск утери",
          traditional: "Высокий",
          traditionalSub: "Потеря оригинала = недействительно. Многие завещания не находят",
          everwill: "Отсутствует",
          everwillSub: "Зашифрованное облако + постоянное хранение в блокчейне",
          highlight: false,
        },
        {
          icon: Zap,
    ...
    hi: {
      ...
      rows: [
        ...
        },
        {
          icon: FileText,
          label: "कानूनी वैधता",
          traditional: "नोटरी वसीयत",
          traditionalSub: "भारतीय उत्तराधिकार अधिनियम 1925 — नोटरी प्रमाणित",
          everwill: "इलेक्ट्रॉनिक प्रमाणित वसीयत",
          everwillSub: "eKYC + ब्लॉकचेन टाइमस्टैम्प + RFC 3161",
          highlight: false,
        },
        {
          icon: AlertTriangle,
          label: "हानि जोखिम",
          traditional: "उच्च",
          traditionalSub: "मूल खो जाए = अमान्य। कई वसीयतें कभी नहीं मिलतीं",
          everwill: "शून्य",
          everwillSub: "एन्क्रिप्टेड क्लाउड + ब्लॉकचेन स्थायी संग्रह",
          highlight: false,
        },
        {
          icon: Zap,
    ...
    pt: {
      ...
      rows: [
        ...
        {
          icon: FileText,
          label: "Validade jurídica",
          traditional: "Testamento em cartório",
          traditionalSub: "Art. 1.864 CC — testamento público",
        ...
        },
        {
          ...
          traditional: "Alto",
          traditionalSub: "Original perdido = inválido. Muitos testamentos nunca são encontrados",
          everwill: "Nenhum",
          everwillSub: "Nuvem criptografada + armazenamento permanente blockchain",
          highlight: false,
        },
        {
          icon: Zap,
