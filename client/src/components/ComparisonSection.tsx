...
export default function ComparisonSection() {
  ...
  const localeData = {
      ...
      rows: [
        {
          ...
          everwill: "99,000원",
          everwillSub: "모든 기능 포함 (보관 + 수정 10회 무료)",
          highlight: true,
        },
        {
          icon: Clock,
    ...
    en: {
      ...
      sectionSub: "Compare traditional estate administration with EverWill — legally valid under your country's electronic signature and wills legislation.",
      ...
      rows: [
        ...
        },
        {
          ...
          traditionalSub: "Traditional probate process · Attorney fees · Court process · 9 months to 2 years",
          everwill: "E-Certified Will",
          everwillSub: "eKYC + RFC 3161 certified timestamp · Legally valid electronic certification · Probate-ready",
          highlight: false,
        },
        {
          icon: AlertTriangle,
