    ...
    en: {
      ...
      rows: [
        ...
        },
        {
          ...
          traditionalSub: "Holographic will: no witnesses needed (25 states) · Notarized will: varies",
        ...
        },
        {
          ...
          traditionalSub: "~67% of Americans have no will · Intestacy laws apply without a will",
          everwill: "Auto Compliance Check",
          everwillSub: "AI flags state-specific requirements · Living trust integration available",
          highlight: false,
        },
        {
          icon: Zap,
