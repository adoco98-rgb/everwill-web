...
const membershipPlans = [
  {
    ...
    certPrice: 49000,
    storagePrice: 24900,
    originalStoragePrice: 29700,  // 9,900 x 3
    discountRate: "16% 할인",
    total: 73900,
    usd: "$74",
    highlight: false,
  ...
  },
  {
    ...
    certPrice: 49000,
    storagePrice: 39000,
    originalStoragePrice: 49500,  // 9,900 x 5
    discountRate: "21% 할인",
    total: 88000,
    usd: "$88",
    highlight: true,
  ...
  },
  {
    ...
    certPrice: 49000,
    storagePrice: 79000,
    originalStoragePrice: 99000,  // 9,900 x 10
    discountRate: "20% 할인",
    total: 128000,
    usd: "$128",
    highlight: false,
  ...
  },
  {
    ...
    certPrice: 49000,
    storagePrice: 199000,
    originalStoragePrice: 198000,  // 9,900 x 20
    discountRate: "최저가",
    total: 248000,
    usd: "$248",
    highlight: false,
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16 max-w-3xl mx-auto">
          {pricingPlans.map((plan, i) => (
            ...
            >
              ...
              <button
                onClick={() => toast.info("서비스 준비 중입니다. 곳 오픈합니다!")}
