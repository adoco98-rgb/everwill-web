...
export const countryPagesData: Record<string, CountryPageData> = {
  ...
  kr: {
    ...
    currency: "KRW", certPrice: "₩168,000", renewPrice: "₩15,000", membershipPrice: "₩29,000/년",
    ...
    ctaTitle: "지금 바로 시작하세요", ctaDesc: "AI 유언장 작성은 무료입니다. 인증만 ₩168,000", ctaButton: "무료로 시작하기",
  ...
  us: {
    ...
    features: [
      ...
      { title: "EverWill NFC Card", desc: "Physical certification card with QR & NFC — emergency identity verification", icon: "CreditCard" },
    ],
    ...
    metaDesc: "ESIGN Act & UEWA 2019 compliant AI will drafting, electronic certification, post-death execution support. Start free.",
  },
  ...
  jp: {
    ...
    features: [
      ...
      { title: "EverWill NFC Card", desc: "QR・NFC搭載の実物認証カード", icon: "CreditCard" },
    ],
  ...
  cn: {
    ...
    features: [
      ...
      { title: "EverWill NFC Card", desc: "内置QR·NFC的实体认证卡", icon: "CreditCard" },
    ],
  ...
  de: {
    ...
    features: [
      ...
      { title: "EverWill NFC Card", desc: "Physische Zertifizierungskarte mit QR & NFC", icon: "CreditCard" },
    ],
  ...
  es: {
    ...
    features: [
      ...
      { title: "EverWill NFC Card", desc: "Tarjeta de certificación física con QR y NFC", icon: "CreditCard" },
    ],
  ...
  sa: {
    ...
    features: [
      ...
      { title: "EverWill NFC Card", desc: "بطاقة توثيق مادية مزودة بـ QR و NFC", icon: "CreditCard" },
    ],
  ...
  fr: {
    ...
    features: [
      ...
      { title: "EverWill NFC Card", desc: "Carte de certification physique avec QR et NFC", icon: "CreditCard" },
    ],
  ...
  ru: {
    ...
    features: [
      ...
      { title: "EverWill NFC Card", desc: "Физическая карта сертификации с QR и NFC", icon: "CreditCard" },
    ],
  ...
  in: {
    ...
    features: [
      ...
      { title: "EverWill NFC Card", desc: "QR और NFC के साथ भौतिक प्रमाणीकरण कार्ड", icon: "CreditCard" },
    ],
  ...
  br: {
    ...
    features: [
      ...
      { title: "EverWill NFC Card", desc: "Cartão de certificação físico com QR e NFC", icon: "CreditCard" },
    ],
  ...
  au: {
    ...
    features: [
      ...
      { title: "EverWill NFC Card", desc: "Physical certification card with QR & NFC", icon: "CreditCard" },
    ],
    ...
    metaDesc: "Succession Act compliant AI will, electronic certification, post-death execution support. Start free.",
    reviews: [
  ...
  nz: {
    ...
    metaDesc: "Wills Act 2007 compliant AI will, electronic certification, post-death execution support. Start free.",
    reviews: [
      ...
      { name: "Catherine Lim", age: "61", location: "Tauranga", rating: 5, text: "The post-death execution support service is what sold me. My family will not have to deal with probate stress — EverWill handles everything after I'm gone. Brilliant.", avatar: "C" },
    ],
  },
  ...
  ca: {
    ...
    metaDesc: "WESA & Electronic Wills Act compliant AI will, electronic certification, post-death execution support. Start free.",
    reviews: [
      ...
      { name: "Sandra Kim", age: "56", location: "Mississauga, ON", rating: 5, text: "The post-death execution support service is what convinced me. My family won't have to navigate probate court alone — EverWill and their lawyers handle everything. Brilliant.", avatar: "S" },
    ],
  },
};
