          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-3 pt-2">
                ...
                <Link href="/">
                  <a className="w-full border-2 border-[#1F3864] text-[#1F3864] py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 hover:bg-[#1F3864]/5 transition-all">
                    홈으로 돌아가기
                  </a>
                </Link>
              </div>
