...
const T: Record<Lang, TranslationData> = {
  ko: {
    ...
    comp_rows: [
      ...
      { feature: "NFC 인증 카드 시스템", ew: "✅ 세계 최초", tw: "❌", fw: "❌", gt: "❌" },
      { feature: "다층 안심 확인", ew: "✅ 자동화", tw: "❌ 수동", fw: "❌ 수동", gt: "❌ 수동" },
    ...
    diff_1_title: "NFC 인증 카드 시스템", diff_1_desc: "MedicAlert + AirTag + 유언 인증을 하나로. 전 세계 어떤 유언 플랫폼도 시도하지 않은 영구적 차별화.",
    diff_2_title: "다층 안심 확인", diff_2_desc: "가족 신고 → 정부 DB → 정기 안심 확인 서비스 → 응급 발견자. 사후 서비스 지원 트리거 시스템.",
    ...
    rev_3: "카드 판매", rev_3_val: "₩49,000 ~ ₩199,000",
    ...
    rm_1_items: ["MVP 출시", "eKYC 연동", "토스페이먼츠 결제", "NFC 카드 생산"],
    ...
    invest_use_items: [
      { label: "제품 개발", pct: "40%", desc: "₩4억 — AI 유언 작성 엔진, eKYC, 분산 암호화 보안 인증" },
    ...
    invest_detail_items: [
      { category: "제품 개발 (₩4억)", items: [
        ...
        { name: "분산 암호화 기록", amount: "₩40,000,000", note: "Polygon 네트워크, RFC 3161 타임스탬프" },
        { name: "영상 유언 녹화 시스템", amount: "₩50,000,000", note: "녹화·저장·암호화·공개 타이밍 설정" },
        { name: "NFC 카드 연동", amount: "₩50,000,000", note: "NFC 카드 제조 파트너 연결, 앱 연동" },
    ...
    timeline_items: [
      {
        ...
        milestones: [
          ...
          { month: 6, label: "분산 암호화 해시 적용" },
          { month: 8, label: "NFC 카드 연동" },
  ...
  en: {
    ...
    comp_rows: [
      ...
      { feature: "Multi-Layer Safety Confirmation", ew: "✅ Automated", tw: "❌ Manual", fw: "❌ Manual", gt: "❌ Manual" },
    ...
    diff_2_title: "Multi-Layer Safety Confirmation", diff_2_desc: "Family report → Government DB → 정기 안심 확인 서비스 → Emergency finder. Automated execution trigger.",
    ...
    rev_3: "NFC Card Sales", rev_3_val: "$49 ~ $149",
    ...
    rm_1_items: ["MVP launch", "eKYC integration", "Toss Payments", "NFC Card production"],
    ...
    invest_use_items: [
      { label: "Product Development", pct: "40%", desc: "₩400M ($304K) — AI will engine, eKYC, distributed encryption security" },
    ...
    invest_detail_items: [
      { category: "Product Development (₩400M / $304K)", items: [
        ...
        { name: "Distributed Encrypted Hash Record", amount: "₩40M ($30K)", note: "Polygon network, RFC 3161 timestamp" },
        { name: "Video Will Recording", amount: "₩50M ($38K)", note: "Recording, storage, encryption, timed release" },
        { name: "NFC Card System", amount: "₩50M ($38K)", note: "NFC Card manufacturing partner, app integration" },
    ...
    timeline_items: [
      {
        ...
        milestones: [
          ...
          { month: 6, label: "Distributed Encrypted Hash Applied" },
          { month: 8, label: "NFC Card Connected" },
  ...
  ja: {
    ...
    comp_rows: [
      ...
      { feature: "多層安心確認", ew: "✅ 自動化", tw: "❌ 手動", fw: "❌ 手動", gt: "❌ 手動" },
    ...
    diff_2_title: "多層安心確認", diff_2_desc: "家族報告 → 政府DB → 정기 안심 확인 서비스 → 緊急発見者。自動執行トリガーシステム。",
    ...
    rev_3: "NFCカード販売", rev_3_val: "¥7,252 ~ ¥44,252",
    ...
    rm_1_items: ["MVPリリース", "eKYC連携", "Toss Payments決済", "NFCカード生産"],
    ...
    invest_detail_items: [
      { category: "製品開発（₩4億）", items: [
        ...
        { name: "NFCカード連携", amount: "₩5,000万", note: "NFCカード製造パートナー連携、アプリ連携" },
  ...
  zh: {
    ...
    comp_rows: [
      ...
      { feature: "多层安心确认", ew: "✅ 自动化", tw: "❌ 手动", fw: "❌ 手动", gt: "❌ 手动" },
    ...
    diff_2_title: "多层安心确认", diff_2_desc: "家属报告 → 政府数据库 → 정기 안심 확인 서비스 → 紧急发现者。自动执行触发系统。",
    ...
    rev_3: "NFC卡销售", rev_3_val: "¥353 ~ ¥2,160",
    ...
    rm_1_items: ["MVP发布", "eKYC集成", "Toss支付", "NFC卡生产"],
    ...
    invest_detail_items: [
      { category: "产品开发（₩4亿）", items: [
        ...
        { name: "NFC卡集成", amount: "₩5,000万", note: "NFC卡制造合作伙伴，App集成" },
  ...
  de: {
    ...
    comp_rows: [
      ...
      { feature: "Mehrschichtige Sicherheitsbestätigung", ew: "✅ Automatisiert", tw: "❌ Manuell", fw: "❌ Manuell", gt: "❌ Manuell" },
    ...
    diff_2_title: "Mehrschichtige Sicherheitsbestätigung", diff_2_desc: "Familienmeldung → Regierungs-DB → 정기 안심 확인 서비스 → Notfallentdecker. Automatischer Ausführungsauslöser.",
    ...
    rev_3: "NFC-Karten-Verkauf", rev_3_val: "€46 ~ €278",
    ...
    invest_use_items: [
      { label: "Produktentwicklung", pct: "40%", desc: "₩400M (≈€304K) — KI-Engine, eKYC, Distributed Encryption Security" },
    ...
    invest_detail_items: [
      { category: "Produktentwicklung (₩400M / ≈€304K)", items: [
        ...
        { name: "Distributed Encryption Security-Hash-Aufzeichnung", amount: "₩40M (≈€30K)", note: "Polygon-Netzwerk, RFC 3161 Zeitstempel" },
    ...
    timeline_items: [
      {
        ...
        milestones: [
          ...
          { month: 6, label: "Distributed Encryption Security-Hash angewendet" },
  ...
  es: {
    ...
    comp_rows: [
      ...
      { feature: "Confirmación de seguridad multicapa", ew: "✅ Automatizado", tw: "❌ Manual", fw: "❌ Manual", gt: "❌ Manual" },
    ...
    diff_2_title: "Confirmación de seguridad multicapa", diff_2_desc: "Informe familiar → BD gubernamental → 정기 안심 확인 서비스 → Descubridor de emergencia. Disparador de ejecución automática.",
    ...
    rev_3: "Ventas de Badge", rev_3_val: "$49 ~ $149",
    ...
    invest_use_items: [
      { label: "Desarrollo de Producto", pct: "40%", desc: "₩400M ($304K) — Motor IA, eKYC, distributed encryption security" },
    ...
    invest_detail_items: [
      { category: "Desarrollo de Producto (₩400M / $304K)", items: [
        ...
        { name: "Registro Hash Distributed Encryption Security", amount: "₩40M ($30K)", note: "Red Polygon, marca de tiempo RFC 3161" },
    ...
    timeline_items: [
      {
        ...
        milestones: [
          ...
          { month: 6, label: "Hash distributed encryption security aplicado" },
  ...
  ar: {
    ...
    comp_rows: [
      ...
      { feature: "تأكيد السلامة متعدد الطبقات", ew: "✅ آلي", tw: "❌ يدوي", fw: "❌ يدوي", gt: "❌ يدوي" },
    ...
    diff_2_title: "تأكيد السلامة متعدد الطبقات", diff_2_desc: "تقرير الأسرة → قاعدة بيانات الحكومة → 정기 안심 확인 서비스 → مكتشف الطوارئ. نظام تشغيل تلقائي.",
