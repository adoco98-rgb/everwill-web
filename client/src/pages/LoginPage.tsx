    ...
    <div className="min-h-screen bg-gradient-to-br from-[#FAFAFA] to-[#f0f4f8] flex">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 overflow-y-auto">
        ...
        <div className="w-full max-w-md">
          ...
          {/* ── 소셜 로그인 버튼 (탭 바로 아래 — 항상 노출, 스크롤 불필요) ── */}
          {(loginStep === "credentials" || (pageMode === "signup" && signupStep === "account")) && (
            <div className="mb-5">
              <div className="space-y-2.5">
                ...
                <a href="/api/auth/google"
                  ...
                  {pageMode === "login" ? "Google로 계속하기" : "Google로 가입하기"}
                </a>
                {/* 카카오 */}
                <a href="/api/auth/kakao"
                  className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-[#FEE500] bg-[#FEE500] hover:bg-[#F0D800] transition text-sm font-medium text-[#3C1E1E] shadow-sm min-h-[44px]">
                  ...
                  {pageMode === "login" ? "카카오로 계속하기" : "카카오로 가입하기"}
                </a>
                {/* 네이버 */}
                <a href="/api/auth/naver"
                  className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-[#03C75A] bg-[#03C75A] hover:bg-[#02b350] transition text-sm font-medium text-white shadow-sm min-h-[44px]">
              ...
              <div className="relative my-4">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-white px-3 text-gray-400">
                    {pageMode === "login" ? "또는 이메일/휴대폰으로 로그인" : "또는 이메일/휴대폰으로 가입"}
                  </span>
                </div>
              </div>
            </div>
