              ...
              <motion.div key={`login-${loginStep}`} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }}>
                ...
                {loginStep === "credentials" && (
                  <form onSubmit={handleLoginStep1} className="space-y-5">
                    ...
                    {/* ── 소셜 간편 로그인 (상단 배치 — 스크롤 없이 바로 보임) ── */}
                    <div className="space-y-2.5">
                      <a href="/api/auth/google"
                        className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 transition text-sm font-medium text-gray-700 shadow-sm">
                      ...
                      <a href="/api/auth/kakao"
                        className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-[#FEE500] bg-[#FEE500] hover:bg-[#F0D800] transition text-sm font-medium text-[#3C1E1E] shadow-sm">
                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="#3C1E1E">
                          <path d="M12 3C6.477 3 2 6.477 2 10.8c0 2.7 1.6 5.1 4 6.6l-.9 3.3c-.1.3.2.6.5.4l4-2.5c.4.1.9.1 1.4.1 5.523 0 10-3.477 10-7.8S17.523 3 12 3z"/>
                        </svg>
                        카카오로 계속하기
                      </a>
                      <a href="/api/auth/naver"
                        className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-[#03C75A] bg-[#03C75A] hover:bg-[#02b350] transition text-sm font-medium text-white shadow-sm">
                      ...
                      <a href="/api/auth/line"
                        className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border border-[#00B900] bg-[#00B900] hover:bg-[#009900] transition text-sm font-medium text-white shadow-sm">
                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="white">
                    ...
                    <div className="relative my-1">
                      ...
                      <div className="relative flex justify-center text-xs">
                        <span className="bg-white px-3 text-gray-400">또는 이메일/휴대폰으로 로그인</span>
                      </div>
                    </div>
                    ...
                    <div className="relative my-2">
                      ...
                      <div className="relative flex justify-center text-xs">
                        <span className="bg-white px-3 text-gray-400">또는 간편 로그인</span>
                      </div>
                    </div>
                ...
                {signupStep === "account" && (
                  <form onSubmit={handleSignupStep1} className="space-y-5">
                    ...
                    <div className="relative my-1">
                      ...
                      <div className="relative flex justify-center text-xs">
                        <span className="bg-white px-3 text-gray-400">또는 이메일/휴대폰으로 가입</span>
                      </div>
                    </div>
                    ...
                    <div className="relative my-2">
                      ...
                      <div className="relative flex justify-center text-xs">
                        <span className="bg-white px-3 text-gray-400">또는 소셜 계정으로 가입</span>
                      </div>
                    </div>
