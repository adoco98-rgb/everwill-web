...
const STEPS = [
  {
    ...
    bg: "bg-rose-500/10",
    title: "나의 삶과 감사",
    subtitle: "살아오면서 가장 감사했던 순간들을 떠올려 보세요",
    guide: "예시: 가족과 함께한 시간, 이루어낸 것들, 도움받은 사람들...",
    questions: [
      "살아오면서 가장 행복했던 순간은 언제였나요?",
      "가장 감사하게 생각하는 사람은 누구인가요? 그 이유는?",
      "내 삶에서 가장 자랑스러운 일은 무엇인가요?",
    ],
  },
  {
    id: 2,
    ...
    bg: "bg-blue-500/10",
    title: "가족에게 전하는 말",
    subtitle: "사랑하는 가족에게 하고 싶은 말을 자유롭게 적어 주세요",
    guide: "예시: 배우자에게, 자녀에게, 부모님께, 형제자매에게...",
    questions: [
      "배우자(또는 가장 가까운 사람)에게 전하고 싶은 말은?",
      "자녀들에게 남기고 싶은 말과 바람은?",
      "부모님 또는 형제자매에게 하고 싶었던 말은?",
    ],
  },
  {
    id: 3,
    ...
    bg: "bg-amber-500/10",
    title: "삶의 지혜와 가르침",
    subtitle: "후손들에게 전해주고 싶은 삶의 교훈을 나눠 주세요",
    guide: "예시: 인생에서 배운 것들, 후회하는 것들, 꼭 해줬으면 하는 것들...",
    questions: [
      "인생에서 가장 중요하다고 생각하는 가치는 무엇인가요?",
      "다시 살 수 있다면 달리 하고 싶은 일이 있나요?",
      "자녀·후손들이 꼭 기억해줬으면 하는 것은?",
    ],
  },
  {
    id: 4,
    ...
    title: "특별한 부탁과 소망",
    subtitle: "장례, 기념일, 특별한 소망을 남겨 주세요",
    guide: "예시: 장례 방식, 기념일에 해줬으면 하는 것, 특별한 부탁...",
    questions: [
      "장례 방식에 대한 바람이 있으신가요? (화장/매장, 종교 의식 등)",
      "기일이나 특별한 날에 가족들이 해줬으면 하는 것이 있나요?",
      "남은 가족들에게 특별히 부탁하고 싶은 것은?",
    ],
  },
  {
    id: 5,
    ...
    bg: "bg-purple-500/10",
    title: "마지막 인사",
    subtitle: "마지막으로 하고 싶은 말을 자유롭게 적어 주세요",
    guide: "예시: 작별 인사, 사랑 고백, 용서, 화해...",
    questions: [
      "마지막으로 가장 하고 싶은 말은 무엇인가요?",
      "용서하고 싶거나 용서를 구하고 싶은 것이 있나요?",
      "이 유서를 읽는 사람에게 전하고 싶은 마지막 메시지는?",
    ],
  },
];
