...
const PRODUCTS: {
...
}[] = [
  {
    ...
    amount: 168000,
    category: "인증",
    includes: ["무료 수정 10회", "추가 수정 ₩15,000/회"],
  },
  {
    code: "cert_gold",
    name: "전자 인증 Gold (영구 보관)",
    desc: "영구 보관 + 무료 수정 10회",
    amount: 79000,
    category: "인증",
    includes: ["무료 수정 10회", "추가 수정 ₩15,000/회"],
  },
  {
    code: "cert_platinum",
    name: "전자 인증 Platinum (영구 보관)",
    desc: "영구 보관 + 무료 수정 10회 + 모든 서비스 포함",
    amount: 168000,
    category: "인증",
    recommended: true,
    includes: ["무료 수정 10회", "영상 유언장", "자필 스캔"],
  },
  {
    code: "cert_vip",
