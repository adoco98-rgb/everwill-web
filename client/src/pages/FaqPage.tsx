    ...
    items: [
      {
        ...
        a: "네, 있습니다. EverWill은 한국 민법 제1065조~제1072조에서 규정하는 유언 방식 중 '전자서명 기반 자필증서 유언' 및 '녹음 유언' 방식을 지원합니다. 전자인증(₩99,000) 완료 후 발급되는 인증서는 RFC 3161 타임스탬프와 블록체인 해시가 기록되어 법원·금융기관에서 진위 확인이 가능합니다. 단, AI가 제공하는 내용은 법률 정보 제공이며 법률 자문이 아닙니다."
      },
      {
        q: "공증과 다른가요?",
    ...
    items: [
      {
        ...
        a: "네, 완전 무료입니다. 회원가입과 AI 유언장 작성에는 비용이 없습니다. 비용은 법적 효력을 부여하는 '전자 인증' 단계에서만 발생합니다(₩99,000, 모든 기능 포함)."
      },
      {
        q: "결제 후 환불이 가능한가요?",
      ...
      },
      {
        ...
        a: "EverWill 카드는 회원 전용 물리적 인증 카드입니다. QR 코드와 NFC가 내장되어 있어 응급 상황 시 의료진이 스캔하면 가족 연락처와 의료 정보를 확인할 수 있습니다. 전자인증(₩99,000) 시 기본 카드가 포함됩니다."
      },
    ]
  },
  {
