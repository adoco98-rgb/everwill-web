  ...
  const plans = [
    {
      ...
      price: prices.silver,
      desc: data.currency === "KRW" ? "전자 인증 + 영구 보관" : "Certification + 1yr Storage",
      features: [
        ...
        data.currency === "KRW" ? "영구 보관 포함" : "1yr storage included",
      ],
    ...
    },
    {
      ...
      price: prices.gold,
      desc: data.currency === "KRW" ? "전자 인증 + 영구 보관" : "Certification + 3yr Storage",
      features: [
        data.currency === "KRW" ? "실버 플랜 전체 포함" : "Everything in Silver",
        data.currency === "KRW" ? "영구 보관 포함" : "3yr storage included",
    ...
    },
    {
      ...
      desc: data.currency === "KRW" ? "전자 인증 + 영구 보관" : "Certification + 5yr Storage",
      features: [
        data.currency === "KRW" ? "골드 플랜 전체 포함" : "Everything in Gold",
        data.currency === "KRW" ? "영구 보관 포함" : "5yr storage included",
