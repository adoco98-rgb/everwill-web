...
export default function InvestPage() {
  ...
  const INNOVATIONS_KO = [
    { no: "01", title: "물리적 Badge 시스템", desc: "MedicAlert + AirTag + 유언 인증 결합. 스테인레스·티타늄 5종 라인업. 착용 자체가 마케팅.", badge: "세계 최초" },
    { no: "02", title: "4중 사망 감지", desc: "가족 신고 + 정부 DB + Dead Man's Switch + 응급 발견자. 2개 채널 교차 검증 후 자동 집행.", badge: "세계 최초" },
    ...
    { no: "07", title: "자필 유언 스캔 인증", desc: "AI 형식 검증 + 위조 탐지 + 블록체인 무결성 기록." },
