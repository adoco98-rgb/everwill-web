    ...
    documents: [
      {
        id: "exec_family_cert",
        name: "가족관계증명서",
        description: "유언집행자의 가족관계 확인",
        required: true,
        helpLink: { label: "정부24에서 발급", url: "https://www.gov.kr/mw/SS/PUBR/insertPublicForm.do?formId=CERT_FAMILY" },
      },
      {
        id: "exec_resident_reg",
        name: "주민등록등본",
        description: "유언집행자의 현재 주소지 확인",
        required: true,
        helpLink: { label: "정부24에서 발급", url: "https://www.gov.kr/mw/SS/PUBR/insertPublicForm.do?formId=CERT_RESIDENT" },
      },
    ],
    ...
    documents: [
      {
        id: "registry",
        name: "부동산 등기부등본",
        description: "소유권·근저당 등 권리관계 확인",
        required: true,
        helpLink: { label: "인터넷등기소에서 발급", url: "http://www.iros.go.kr" },
      },
      {
        id: "land_ledger",
        name: "토지대장",
        description: "토지의 소재·지번·면적·소유자 확인",
        required: true,
        helpLink: { label: "정부24에서 발급", url: "https://www.gov.kr/mw/SS/PUBR/insertPublicForm.do?formId=CERT_LAND" },
      },
      {
        id: "building_ledger",
        name: "건축물대장",
        description: "건물의 구조·면적·용도 확인",
        required: true,
        helpLink: { label: "세움터에서 발급", url: "https://cloud.eais.go.kr" },
      },
      {
        id: "official_price",
        name: "공시가격 확인원",
        description: "부동산 공시지가 또는 공동주택 공시가격",
        required: false,
        helpLink: { label: "부동산공시가격 알리미", url: "https://www.realtyprice.kr" },
      },
    ],
  },
  {
    ...
    documents: [
      {
        id: "bank_copy",
        name: "통장 사본",
        description: "예금·적금 통장 앞면 사본",
        required: false,
      },
      {
        id: "balance_cert",
        name: "잔액증명서",
        description: "은행 발급 잔액증명 (발급일 기준)",
        required: false,
      },
      {
        id: "stock_cert",
        name: "주식·보험증권 확인서",
        description: "증권사 잔고증명, 보험증권 사본 등",
        required: false,
      },
      {
        id: "subscription_right",
        name: "분양권·기타 재산 확인서",
        description: "분양계약서, 차량등록증 등",
        required: false,
      },
    ],
  },
