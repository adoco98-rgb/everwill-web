...
const LANGS = {
  ko: {
    ...
    subtitle: "세계 최초 디지털 유언 OS — 유언 작성부터 사후 집행 지원까지",
    company: "주식회사 사람 (EverWill Inc.) · 대표 라수환 (Jeff Ra)",
    sections: ["사업 개요", "시장 현황", "국가별 시장", "차별성", "수익 모델", "비전·로드맵", "팀·투자 조건", "투자 문의"],
    s1: "01 사업 개요 및 의의",
    s1mission: "미션",
    s1missionText: "누구나 17분 안에 민법 요건에 맞는 유언장을 완성하고, 사망 후 집행 지원을 받을 수 있는 세상을 만든다.",
    s1vision: "비전",
    s1visionText: "2030년까지 아시아 1위, 글로벌 3위 디지털 유언 플랫폼",
    s1about: "사업 소개",
    s1aboutText: "EverWill은 유언 작성부터 사후 집행 지원까지 전 과정을 책임지는 세계 최초 디지털 유언 OS입니다. Trust & Will·Farewill·GoodTrust 등 글로벌 경쟁사를 뛰어넘는 올인원 글로벌 유언 플랫폼으로, 아시아에 경쟁자가 전무한 블루오션 시장을 선점합니다.",
  ...
  en: {
    ...
    subtitle: "World's First Digital Will OS — From Will Creation to Post-Death Execution Support",
    ...
    s1about: "About",
    s1aboutText: "EverWill is the world's first Digital Will OS, handling everything from will creation to post-death execution support. We outperform Trust & Will, Farewill, and GoodTrust with an all-in-one global platform, entering a blue ocean market with zero competitors in Asia.",
...
const innovations = [
  ...
  { num: "08", title_ko: "재인증 체계 (LTV 28배)", title_en: "Re-certification System", wf: true, desc_ko: "결혺·출산·이사·자산 변동마다 재인증. 최초 ₩168,000 → 재인증 ₩15,000." },
...
const pricingData = [
  ...
  { product: "유언장 인증 (사후 집행 포함)", krw: "₩168,000", usd: "$39", type: "핵심 수익" },
  ...
  { product: "EverWill 실버 카드", krw: "₩168,000", usd: "$49", type: "하드웨어" },
