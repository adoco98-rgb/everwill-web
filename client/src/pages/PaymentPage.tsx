...
const PRODUCTS: { key: ProductKey; name: string; desc: string; amount: number; category: string; recommended?: boolean; badge?: string; includes?: string[] }[] = [
  { key: "certification", name: "전자 인증 기본", desc: "유언장 전자 인증 · 블록체인 해시 기록 · 인증서 발급", amount: 168000, category: "인증", includes: ["무료 수정 1회", "추가 수정 ₩5,000/회"] },
  ...
  { key: "card_silver", name: "Card Silver", desc: "스테인레스 카드형 · QR + NFC", amount: 168000, category: "Card" },
  { key: "card_gold", name: "Card Gold", desc: "티타늄 팔찌형 · QR + NFC", amount: 79000, category: "Card" },
  { key: "card_platinum", name: "Card Platinum", desc: "로즈골드 목걸이형 · QR + NFC", amount: 168000, category: "Card" },
